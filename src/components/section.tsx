...
export default function Section({ children, className = "", head, subHead = "" }: SectionProps) {
  return (
          ...
          <span>
            ...
            >
              <path
                ...
                strokeWidth="1.5"
              ></path>
              <path opacity="0.5" d="M12 2V4" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path opacity="0.5" d="M12 20V22" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path opacity="0.5" d="M2 12L4 12" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path opacity="0.5" d="M20 12L22 12" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path d="M6 18L6.34305 17.657" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path d="M17.6567 6.34326L18 6" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path d="M18 18L17.657 17.657" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
              <path d="M6.34326 6.34326L6 6" stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
            </svg>
          </span>
        </div>
        {subHead && (
